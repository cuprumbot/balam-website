...
$(document).ready(function() {
    ...
    $(".countdown")
        .countdown("2023/03/06", function(event) {
            $(this).html(
                ...
                event.strftime('<div>%D <span>Días</span></div>  <div>%H<span>Horas</span></div> <div>%M<span>Minutos</span></div> <div>%S<span>Segundos</span></div>')
            );
        });
